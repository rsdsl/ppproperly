...
mod tests {
    ...
    fn test_serialize_pppoe_padi() -> Result<()> {
        ...
        assert_eq!(
            ...
            &[
                ...
                0x11, 0x09, 0x00, 0x00, 0x00,
                /*0x06*/ 0x00 /*, 0x01, 0x03, 0x00, 0x02, 0x0d, 0x25*/
            ]
        );
        Ok(())
    }
    ...
    fn test_deserialize_pppoe_padr() -> Result<()> {
        let mut padr = PPPoEPADRPkt::default();
    ...
    fn test_deserialize_pppoe_pads() -> Result<()> {
        let mut pads = PPPoEPADSPkt::default();
