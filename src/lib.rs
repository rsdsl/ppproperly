...
mod tests {
    ...
    fn test_serialize_lcp_echo_request() -> Result<()> {
        ...
        assert_eq!(
            ...
            &[
                0x00, 0x00, 0x5e, 0x00, 0x53, 0x02, 0x00, 0x00, 0x5e, 0x00, 0x53, 0x01, 0x88, 0x64,
                0x11, 0x00, 0x00, 0x01, 0x00, 0x0a, 0xc0, 0x21, 0x09, 0x41, 0x00, 0x08, 0x13, 0x37,
                0x41, 0x41
            ]
        );
        Ok(())
    ...
    fn test_serialize_lcp_echo_reply() -> Result<()> {
        ...
        assert_eq!(
            ...
            &[
                0x00, 0x00, 0x5e, 0x00, 0x53, 0x01, 0x00, 0x00, 0x5e, 0x00, 0x53, 0x02, 0x88, 0x64,
                0x11, 0x00, 0x00, 0x01, 0x00, 0x0a, 0xc0, 0x21, 0x0a, 0x41, 0x00, 0x08, 0x13, 0x37,
                0x41, 0x41
            ]
        );
        Ok(())
    ...
    fn test_serialize_lcp_discard_request() -> Result<()> {
        ...
        assert_eq!(
            ...
            &[
                0x00, 0x00, 0x5e, 0x00, 0x53, 0x02, 0x00, 0x00, 0x5e, 0x00, 0x53, 0x01, 0x88, 0x64,
                0x11, 0x00, 0x00, 0x01, 0x00, 0x0a, 0xc0, 0x21, 0x0b, 0x41, 0x00, 0x08, 0x13, 0x37,
                0x41, 0x41
            ]
        );
        Ok(())
